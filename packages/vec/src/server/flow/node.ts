...
import { db } from '../../db'
import { flowNode } from '../../db/schema/flow-node'
...
export const createFlowNodeServerFn = createServerFn({ method: 'POST' })
...
export const removeFlowNodeServerFn = createServerFn({ method: 'POST' })
